...
export default {
  ...
  methods: {
    ...
    loadMarker() {
      ...
      //   );
      //   let LatLng = new kakao.maps.LatLng(this.mapY, this.mapX);
      //   console.log(LatLng);
      //   const marker = new kakao.maps.Marker({
      //     map: this.map, // 마커를 표시할 지도
      //     position: new kakao.maps.LatLng(this.mapY, this.mapX), // 마커를 표시할 위치
      //     title: this.facltNm, // 마커의 타이틀, 마커에 마우스를 올리면 타이틀이 표시됩니다
      //     image: markerImage,
      //   });
      //   this.map.setCenter(new kakao.maps.LatLng(this.mapY, this.mapX));
